    ...
    return (
        <div className='min-h-screen bg-gradient-to-br from-white via-indigo-50 to-purple-50'>
            ...
            <div className='max-w-4xl mx-auto py-10 px-4'>
                <div className='bg-white/70 backdrop-blur-xl border border-white/50 rounded-2xl shadow-xl overflow-hidden p-8'>
                    <div className='mb-8'>
                    ...
                    <div className='flex items-center gap-4 mt-8'>
                        <Button variant="outline" onClick={() => navigate("/admin/companies")} className="rounded-xl border-gray-300 hover:bg-gray-100 h-11 px-8">Cancel</Button>
                        <Button onClick={registerNewCompany} className="bg-gradient-to-r from-violet-600 to-indigo-600 hover:from-violet-700 hover:to-indigo-700 text-white rounded-xl shadow-lg h-11 px-8">Continue</Button>
                    </div>
                </div>
            </div>
        </div>

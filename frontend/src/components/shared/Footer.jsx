      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-4 md:mb-0">
            ...
            <p className="text-sm">© 2025 JobBridge. All rights reserved. Made with ❤️ by Team JobBridge.</p>
          </div>
          
          <div className="flex space-x-4 mt-4 md:mt-0">
            <a href="https://www.facebook.com/Growwithtahira/?viewas=100000686899395" className="hover:text-gray-400" aria-label="Facebook">
            ...
            <a href="https://x.com/growwithtahira" className="hover:text-gray-400" aria-label="Twitter">
            ...
            <a href="https://www.linkedin.com/in/tahira-fatima-6ab721280/" className="hover:text-gray-400" aria-label="LinkedIn">
